...
### V40 one-million-row direct and accepted-spill routing falsifier

V40 tested whether a query-blind router could realize the V39 K=21 feasible
layout on the same frozen ReLAION2B cohort A: 1,000,000 non-null `f32[768]`
corpus vectors, 1,000 burned development queries, and exact binary64 no-FMA
GT@100. Selection never received ground truth. Truth evaluation opened only
...
and source archive (40,683,520 bytes, SHA256
`2b6e22e261d028638104dadf1ac1711bc824c14a5c8bbc91d2bcca942865ca28`).
Across 1,024 warmups and 10,000 timed samples, the complete synthetic
SRHT-192 projection, 447-pop tree frontier, and exact 2,112-candidate greedy
selection measured 4,319,512 ns p99 against the 5,000,000-ns gate. It executed
44,142 comparisons and 672 category invalidations, selected 21 postings, and
used 4,288,512 bytes peak cgroup memory with zero swap and zero memory PSI.
The 93,514-byte samples artifact is SHA256
`d6cad12bb480a237615ddacb7b5dc9c02fbe995d92f06e0c352e6c829e83e46a`.
The preflight artifacts are preserved under
`s3://borsuk-bench-453182569524-euc1/research/v40-router/597452727b70521b806b9ce0958ba056bf7f512b/preflight/`.

The previously frozen direct selection at source
`b9d75df7ab68a79c577e976c383bce1d75edd41a` selected 21 postings/query with
56.923 mean and 77 maximum node pops. Its 53,537-byte Parquet selection is
SHA256 `5bfd83995bf873c262caf22bc380b757c60aa5bc5505b2ef646f6ed1ac8cc9d3`.
Truth evaluation measured 91,801/100,000 hits: 918,010 ppm aggregate recall,
90,000 ppm minimum, 970,000 ppm median, and 324 perfect queries. The canonical
185,389-byte direct result is SHA256
`1f8b812607faf8227522c9b49ed07fa1f82b2d21b9da72cb299a15fa7f31d559`.
The missing derived direct-failure decision was regenerated byte-for-byte from
those immutable inputs at source `597452727b70521b806b9ce0958ba056bf7f512b`;
evaluation took 1.19 seconds and 119,028 KiB peak RSS. The canonical 3,598-byte
decision is SHA256
`7b56fb439d2537ec18713c4969c17094f8a40abf42f123fb98110139cf0dd513`.

The accepted-spill challenger reused only the frozen 25,136,186-byte relation,
3,608-byte posting summary, 1,558,506-byte query artifact, 2,046,505-byte GT,
and small authorities; it did not download corpus vectors or page bodies. The
summary phase retained 3,790 alternate categories across 123 postings in a
34,402-byte packed artifact, taking 0.15 seconds and 11,040 KiB peak RSS. The
query-only selection considered 64 frontier postings and selected 21; it took
1.07 seconds and 17,548 KiB peak RSS. Its 71,090-byte Parquet selection is
SHA256 `32643aca5f1fab0d7c05cce2c6924c15f8af3a95aea2c5003d330b07a8313368`.
Truth evaluation took 1.22 seconds and 119,440 KiB peak RSS and measured
91,307/100,000 hits: 913,070 ppm aggregate recall and 90,000 ppm minimum.
The 270,234-byte canonical result is SHA256
`dbeda17f200ff81a047f93af315173620464c861becddc55b8aa303bea9810a9`
and BLAKE3
`ed252705e6105f941730303d2b24a644e1fa6ecbdec9a4407cd04effe66e165f`
under
`s3://borsuk-bench-453182569524-euc1/research/v40-router/597452727b70521b806b9ce0958ba056bf7f512b/challenger-a0001/`.
Every admitted phase reported zero swap and zero memory PSI. One initial
selection invocation used 16 workers instead of the frozen V37 authority's 32;
...
explicit scratch clearance. D3, paid large-scale work, and claim-eligible
comparison remain fenced.
