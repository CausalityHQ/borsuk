...
| v4 | `7e63acf53e15f75861cdfd671ca044d68f5a11706a4b7e7b9df826b37ed839b2` | `c41b1f16bb0871fc6c2ca943220f701520f9b689834574079582f6b3f2452d47` | `s3://borsuk-bench-453182569524-euc1/research/logical-cell-routing-diagnostic/20260802-v4/results/` | `s3://borsuk-bench-453182569524-euc1/research/logical-cell-routing-diagnostic/20260802-v4/indexes/flat` | complete and structurally valid from clean format-v20 revision `a311450` on the isolated `c7g.8xlarge`; success marker present, failure marker absent, process exit 0, 40 unique samples, and exact sample/request and distinct-cell reconciliation. Claim-ineligible output records 11.403s measured wall time, 3.10 CPU-seconds, p50 0.831s, p95 3.220s, 3.508 appends/s, and 6,130 storage requests |
...
The terminal v4 diagnostic materially improves on v1: requests fall 54.1%,
throughput rises 89.0%, and p95 falls 50.8%. These are directional deltas from
one claim-ineligible repetition per revision, not stable performance estimates
or routing claims. They clear the preregistered bounded diagnostic gate for an
honest paired matrix from the exact format-v20 revision.
