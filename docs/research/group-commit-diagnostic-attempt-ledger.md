...
| v7 | `16b4ac4` | `187ffc4b895bf043c7a51c0f0b581cd3319c94eb099d43fb7c79f7fd389b653e` | `293c573172c5a210e6e759e03fa3ca1625501fbd79ad1fdc404d6cfb002c56eb` | `s3://borsuk-bench-453182569524-euc1/research/group-commit-diagnostic/20260803-v7/results/` | `s3://borsuk-bench-453182569524-euc1/research/group-commit-diagnostic/20260803-v7/index` | running on the isolated `c7g.8xlarge` from fresh prefixes; claim-free last-write-wins group commit, concurrent descriptor/payload upload, and exact live-tail scoring are frozen from the clean source archive |
...
Terminal v6 is correctness evidence for durable group commit, not acceptable
production performance. Its 20.694-second measured append window and 4% CPU
utilization show a remote-wait-bound path; they do not identify one individual
request as causal. The full routing/publication matrix remains blocked.
