...
| aws-v3 | `c0fd3524f55d03f894e85c1ff7f6e36ad8ddbea874fbe4062bc1ff42afde94a2` | pending delivered source archive | EC2 Spot `c7g.8xlarge`, eu-central-1, S3-only | Preregistered, not launched. The authoritative 60-arm plan has a 19,800-second worst-case bound within the 21,600-second campaign deadline; terminal publication has 120 seconds of systemd stop grace for a 60-second S3 timeout. Launch is permitted only from a clean revision already fast-forwarded to `origin/main`, with no other BORSUK worker active. |
