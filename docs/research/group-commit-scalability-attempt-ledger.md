...
qualification uses checksum-pinned 768D Cohere vectors, 1, 8, and 32 independent
writer processes, one process-local commit lane per writer, and five paired
repetitions; it remains ineligible for
...
| v62-independent-processes-aws | `d8a624a` | `9248f7edc8e03aa085999cb02fc83a4e2df62f759fc5d47d03f4e4b8f807d5f7` | `81c849548d9ef7300cffd88a0a13aca2023645ae0af40e66f0da5a60ad37408a` | `s3://borsuk-bench-453182569524-euc1/research/group-commit-scalability/20260807T184600Z-d8a624a/results/` | `s3://borsuk-bench-453182569524-euc1/research/group-commit-scalability/20260807T184600Z-d8a624a/index/` | terminal production-gate failure at `c2000/r01/l1/w8`. The preceding independent `w1` process passed every gate with write p95 110.287 ms, 702 records/s, active-tail read p95 124.681 ms, post-drain read p95 55.260 ms, and recall 1.0. Eight distinct writer processes preserved all 128,000 records and recall 1.0, but failed at 1,376.614 ms write p95, 1,302 records/s, 493.610 ms active-tail read p95, and 287.722 ms post-drain read p95. The root and terminal-cell fail-closed validators rejected the immutable artifacts before CSV inspection. Terminal raw samples then proved the hot global generation counter caused 3-request groups to expand as high as 99 requests: up to 49 contended GET+CAS retries before one extent PUT, with 4.095-second group latency. The trace also exposed epoch extent paths misclassified as `unknown`; the next verified slice classifies them as WAL runs. No later cell ran and no incomplete CSV was opened. |
| v63-arrow-delta-aws | `a8e35b6` | `91e984a39c77cdd9c6896d6bb519003ecc1bf438cbb0119494466189199f9e7d` | `81c849548d9ef7300cffd88a0a13aca2023645ae0af40e66f0da5a60ad37408a` | `s3://borsuk-bench-453182569524-euc1/research/group-commit-scalability/20260808T043300Z-v31-a8e35b6/results/` | `s3://borsuk-bench-453182569524-euc1/research/group-commit-scalability/20260808T043300Z-v31-a8e35b6/index/` | terminal production read-p95 failure at `c2000/r01/l1/w8` after `w1` completed every gate. The repository root validator first rejected the immutable campaign as incomplete because no success marker exists; both terminal-cell invocations then rejected the root failure marker. Only after those fail-closed failures, terminal CSV inspection found 128,000/128,000 records visible, inserted-ID recall@10 1.0, 85.778 ms write p95, 6,844 acknowledged records/s, 2,335 drain-inclusive records/s, and 142.946 ms active-tail read p95, but 7,082.046 ms post-drain read p95. Each post-drain query searched 24 segments despite the four-segment budget, issued 49--58 GETs, and fetched about 493 MB; 5.9--6.8 seconds was isolated to the parallel materialized-delta wait. The terminal storage trace showed an empty delta descriptor and a 48.7 MB standard Arrow bundle written without a final descriptor. Parsing that immutable bundle reproduced the suppressed cause at batch 1: BORSUK required exactly one 64-byte gap between typed Arrow buffers, while the standard Arrow writer legally emitted a 128-byte gap. The new format-v4 global-PQ reference persists all six buffer starts, accepts legal Arrow padding, and makes delta-build failure abort drain before manifest publication instead of silently publishing an unindexed many-segment overlay. No later matrix cell ran and no incomplete CSV was opened. |
| v64-adaptive-rerank-aws | `622ab0c` | `57387c0f3109f6792d24549a4d56f6dbd97bddcc9dc9e801c7d53fb16a94a81e` | `81c849548d9ef7300cffd88a0a13aca2023645ae0af40e66f0da5a60ad37408a` | `s3://borsuk-bench-453182569524-euc1/research/group-commit-scalability/20260808T054400Z-v4-622ab0c/results/` | `s3://borsuk-bench-453182569524-euc1/research/group-commit-scalability/20260808T054400Z-v4-622ab0c/index/` | terminal production read-p95 failure at `c2000/r01/l1/w8` after `w1` completed every gate. The repository root validator first rejected the immutable campaign as incomplete, and both terminal-cell invocations rejected the root failure marker. Only after those fail-closed outcomes, terminal inspection found 128,000/128,000 records visible, inserted-ID recall@10 1.0, 84.498 ms write p95, 6,570.980 acknowledged records/s, 2,113.993 drain-inclusive records/s, and 138.087 ms active-tail read p95, while post-drain read p95 was 277.243 ms. This confirms the format-v4 fix removed the prior 7,082 ms many-segment failure: every query respected the four-segment budget and fetched 0.3--1.2 MB. The remaining terminal trace showed 6--20 GETs/query and 0--218.611 ms global-delta wait. The immutable delta descriptor contained 128,000 vectors in 256 cells with exactly one chunk per cell across nine standard Arrow bundles; each query probed one delta cell, then fetched 16 scattered 768D exact rows. The next candidate preserves all candidates and recall while folding a dense shortlist into one cost-justified range GET only when its complete envelope is at most 4 MiB; sparse and larger cells retain the 64 KiB coalescing policy. No later matrix cell ran and no incomplete CSV was opened. |
| v65-dense-rerank-aws | `1dde875` | `3670b41952fb6af0758238474a01e6c38cf773dd5eb44c5c044587f3caa2991b` | `81c849548d9ef7300cffd88a0a13aca2023645ae0af40e66f0da5a60ad37408a` | `s3://borsuk-bench-453182569524-euc1/research/group-commit-scalability/20260808T065500Z-v65-1dde875/results/` | `s3://borsuk-bench-453182569524-euc1/research/group-commit-scalability/20260808T065500Z-v65-1dde875/index/` | terminal production read-p95 failure at `c2000/r01/l1/w8` after `w1` completed every gate. Root validation first rejected the immutable campaign as incomplete, and both terminal-cell invocations rejected the root failure marker. Only after those fail-closed outcomes, terminal inspection found 128,000/128,000 records visible, recall@10 1.0, 80.333 ms write p95, 7,171.488 acknowledged records/s, 2,171.201 drain-inclusive records/s, 145.839 ms active-tail read p95, and 237.196 ms post-drain read p95. Adaptive dense-rerank coalescing improved the preceding terminal p95 by 40.047 ms and reduced completed-query GETs from 310 to 297, but did not pass; median post-drain latency improved from 143.539 to 133.410 ms while terminal bytes rose from 10.412 to 11.994 MB. Per-query request counts remained 6--20 because code fetch and exact rerank still formed dependent remote waves. Cached-code samples completed delta ADC in about 0.3 ms, while uncached delta approximate time reached 151.596 ms and exact rerank reached 118.960 ms, isolating remote staging rather than SIMD scoring. The next candidate retains the selected standard-Arrow code-to-exact cell envelope during the code GET only when the complete span is at most 4 MiB; larger cells remain code-only and sparse-reranked. No later matrix cell ran and no incomplete CSV was opened. |
| v66-bounded-cell-prefetch-aws | `78b0d77` | `eed35638eb0333a4940ab7641206d312c406bedf0a0ec0021e2f3505e47ab328` | `81c849548d9ef7300cffd88a0a13aca2023645ae0af40e66f0da5a60ad37408a` | `s3://borsuk-bench-453182569524-euc1/research/group-commit-scalability/20260808T074200Z-v66-78b0d77/results/` | `s3://borsuk-bench-453182569524-euc1/research/group-commit-scalability/20260808T074200Z-v66-78b0d77/index/` | terminal production read-p95 failure at `c2000/r01/l1/w8` after `w1` completed every gate. Root and terminal-cell validators first failed closed on the root failure marker. Only after terminal validation, inspection found 128,000/128,000 records visible, inserted-ID recall@10 1.0, 78.009 ms write p95, 7,380.067 acknowledged records/s, 2,210.523 drain-inclusive records/s, 127.790 ms active-tail read p95, and 203.884 ms post-drain read p95. Relative to v65, query-local bounded-cell prefetch reduced post-drain p95 by 33.312 ms and completed-query GETs from 297 to 111 while preserving the candidate budget and recall, but missed the strict read gate by 3.884 ms. Exact delta rerank was about 0.2 ms for 17/20 queries; the remaining tail moved into delta approximate staging, which reached 199.911 ms while fetching selected 1.4--4.1 MB standard-Arrow cell envelopes. This rules out exact-row scoring as the general remaining bottleneck and shows that whole-cell exact payload transfer is too large for a reliably sub-200 ms uncached S3 approximate stage. No later matrix cell ran and no incomplete CSV was opened. |
| v67-striped-cell-prefetch-aws | `40911df` | `4ea819fbb9cb4e203811410e40f7c158dca5fc18a3644012d96341155aa52423` | `81c849548d9ef7300cffd88a0a13aca2023645ae0af40e66f0da5a60ad37408a` | `s3://borsuk-bench-453182569524-euc1/research/group-commit-scalability/20260808T091300Z-v67-40911df/results/` | `s3://borsuk-bench-453182569524-euc1/research/group-commit-scalability/20260808T091300Z-v67-40911df/index/` | terminal post-drain read-p95 failure at `c2000/r01/l1/w8` after `w1` completed every gate. Root validation first rejected the campaign as incomplete and terminal-cell validation rejected the root failure marker. Only then did terminal inspection find 128,000/128,000 records visible, recall@10 1.0, 83.387 ms write p95, 7,057.627 acknowledged records/s, 2,125.613 drain-inclusive records/s, 110.695 ms active-tail read p95, and 210.608 ms post-drain read p95. The 20 post-drain queries used 94 GETs and 56,479,636 logical bytes. Relative to v66, mean latency improved from 103.841 to 101.940 ms, mean GETs from 5.55 to 4.70, and two of three exact-rerank latency outliers disappeared, but p95 worsened by 6.725 ms under remote variance. The same 3.70 MB query shifted from 117.956 ms with three GETs to 210.608 ms with five GETs as its delta approximate stage shifted from 114.081 to 206.748 ms. This rejects 1 MiB striping as a robust production tail fix: it lowers average requests/work but increases exposure to a slow member of a four-stripe remote wave. The first query also paid an unreported cold delta-descriptor/setup interval before its timed approximate stage. Worker health remained green with 59 GiB available memory and 130 GiB free disk. No later matrix cell ran and no incomplete CSV was opened. |
