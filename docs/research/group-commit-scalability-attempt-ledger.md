...
| v6 | pending | pending | pending | pending | pending | preregistered diagnostic retry adds gate-specific marker topology and runs the complete 2K matrix before constructing 16K, allowing immediate marker-only diagnosis without wasting the larger bootstrap |
