...
| v5 | `353a6646daf2f234685905eb12b5c12d4233e4a7c8a96dfca72ebd643e49155d` | `4d43087fa7b12ae95ed75fa874823796769ff4dafeee10752b485b3c60d549cc` | `s3://borsuk-bench-453182569524-euc1/research/logical-cell-routing/20260802-v5/results/` | `s3://borsuk-bench-453182569524-euc1/research/logical-cell-routing/20260802-v5/indexes/` | running from clean revision `8674a2d` with failure-aware coordinated startup and a preregistered 1,800-second per-cell timeout; the fresh attempt prefix was empty, the worker was idle, source and manifest objects were uploaded with SSE-S3, their checksums were verified, and the identical five-repetition 2K/16K by 1/8/32-writer paired matrix launched on `c7g.8xlarge` in `eu-central-1` |
