...
| v3 | `ff62ebb0641e9c115c0600f10eb1428e22d93fdadb37ee10b6b1f003b06bf8ef` | `b07a617061245b3f60fe0f40948746fa0c2790c3e042b012a5c0c902e22644d1` | `s3://borsuk-bench-453182569524-euc1/research/logical-cell-routing/20260731-v3/results/` | `s3://borsuk-bench-453182569524-euc1/research/logical-cell-routing/20260731-v3/indexes/` | running from the identical revision `a4a4dcf` source object with explicit `AWS_REGION` and `AWS_DEFAULT_REGION` set to `eu-central-1`; fresh prefixes were empty before launch and no competing benchmark process was present |
