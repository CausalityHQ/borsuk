...
def assert_routing_topology_docs(docs: dict[str, str]) -> None:
    required_by_path = {
        "README.md": [
            ...
            "Single-level routing is only the small-index degenerate case",
            "`routing_page_fanout`",
...
def main() -> None:
    ...
    locked_cargo_commands = {
        ...
        "crates/borsuk/src/format.rs": [
            ...
            "segment_from_parquet_requires_persisted_pq_codes",
        ...
        "crates/borsuk/src/segment.rs": [
            "EXACT_GRAPH_RECORD_LIMIT",
            "GRAPH_CANDIDATE_WINDOW",
            "fn exact_graph_edges",
            "fn bounded_graph_edges",
            "fn graph_candidate_indices",
            "large_segment_graph_tie_breaks_duplicate_vectors_locally",
        ],
        ...
        "crates/borsuk-cli/tests/cli.rs": [
            ...
            "cli_create_supports_routing_page_fanout",
        ...
        "crates/borsuk/tests/local_index.rs": [
            ...
            "collection_snapshot_rejects_corrupt_pivot_table",
        ...
        "docs/api.md": [
            ...
            "routingPageOverfetch",
            "large graph blocks use vector-locality and routing-code candidate windows",
        ...
        "docs/architecture.md": [
            ...
            "bounded vector-locality and routing-code candidate windows",
            "instead of all pairs in the segment",
            "multi-level binary routing tree",
            "The right production model is not one flat map followed by boxes of vectors",
            "BORSUK uses a map of maps",
            "This does not put vectors in higher layers",
    ...
    assert_benchmark_numeric_rows(
        ...
        large_scale_rows,
        {
            ...
            "compaction_bytes_written": 1.0,
            "gc_ms": 0.000001,
            "gc_objects_scanned": 1.0,
            "gc_objects_deleted": 1.0,
            "gc_bytes_reclaimed": 1.0,
            "routing_page_overfetch": 1.0,
            "query_ms": 0.000001,
