#!/usr/bin/env python3
"""Score sealed V214 PQ-graph IDs against paired 100k truth and V193."""
...
def run(args: argparse.Namespace) -> None:
    ...
    if (serving.get("schema") != "borsuk-v214-pq-graph-100k-v1"
        ...
        raise ValueError("V214 pretruth/baseline identity differs")
    ...
    args.summary.write_text(canonical({
        "schema": "borsuk-v214-pq-graph-100k-summary-v1",
