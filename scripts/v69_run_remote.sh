#!/bin/bash
set -u
digest=dafe02e403d6bde20aaa47d6abc55a44e1a9a98af620133d7f8e27ea3dcd63b8
root=/mnt/v69-sweep-dafe02e4
prefix=s3://borsuk-bench-453182569524-euc1/research/v69-algorithm-first/serving-sweep-dafe02e403d6bde2
output_uri="$prefix/a0001"
terminal_file=/tmp/v69-terminal.json
phase=bootstrap
publish_terminal() {
  code=$?
  trap - EXIT
...
aws s3 cp "$prefix/v69_algorithm_first_serving_sweep.py" probe.py --only-show-errors || exit 92
