#!/bin/bash
set -u
digest=14361edac84d30070ccd4b6818b69257496ad870beec1a3da2450cd34042016b
root=/mnt/v66-router-ram-14361eda
prefix=s3://borsuk-bench-453182569524-euc1/research/v66-algorithm-first/router-ram-14361edac84d3007
output_uri="$prefix/a0001"
terminal_file=/tmp/v66-router-ram-terminal.json
phase=bootstrap
publish_terminal() {
  code=$?
  trap - EXIT
...
aws s3 cp "$prefix/v66_algorithm_first_router_ram.py" probe.py --only-show-errors || exit 92
