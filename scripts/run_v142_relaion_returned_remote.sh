...
download_checked low.bin "$v115/low.bin" 3072 ce036f48f918312f694adbd12994646987eb0e144df20f64ffe583bed0d1f891
download_checked step.bin "$v115/step.bin" 3072 64d49c7413f163fb3446183629d743f69199156f208fa959523d1bcde27da69c
...
run_science replay bash -c \
  ...
  --low low.bin --step step.bin --requests requests.jsonl \
  --sealed sealed.jsonl --v140-raw v140-raw.jsonl \
  --replay replay.jsonl
