...
root=/mnt/v54-binary-scan-f6ce623b
output_uri=s3://borsuk-bench-453182569524-euc1/research/v54-algorithm-first/binary-scan-f6ce623bb58cbba1/a0001
mkdir -p "$root"
cd "$root" || exit 90

aws s3 cp s3://borsuk-bench-453182569524-euc1/research/v54-algorithm-first/binary-scan-f6ce623bb58cbba1/v54_algorithm_first_binary_scan.py probe.py --only-show-errors || exit 91
aws s3 cp s3://borsuk-bench-453182569524-euc1/research/v54-algorithm-first/binary-scan-f6ce623bb58cbba1/v53_algorithm_first_page_mlp.py v53_algorithm_first_page_mlp.py --only-show-errors || exit 92
...
aws s3 cp s3://borsuk-bench-453182569524-euc1/research/v38-query-blind-boundary-spill/ab96e6863623830f85388fb0a27e530b6f08dff7/runs/v38-build-20260913T062600Z-ab96e686/attempt-0000/spill-relation relation.parquet --only-show-errors || exit 96

sha256sum -c > hashes.log 2>&1 <<'HASHES'
f6ce623bb58cbba1293ec7de4031c708780200bdc44a8ec17eb550607c92219d  probe.py
...
printf '{"exit_code":%d,"script_sha256":"f6ce623bb58cbba1293ec7de4031c708780200bdc44a8ec17eb550607c92219d"}\n' "$code" > terminal.json
for name in hashes.log run.log time.log terminal.json; do
