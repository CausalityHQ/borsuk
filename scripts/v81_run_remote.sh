#!/bin/bash
set -u
root=/mnt/v81-bounded-pool
prefix=s3://borsuk-bench-453182569524-euc1/research/v81-algorithm-first/bounded-pool
...
c3983ff0f7cfe356839863b0b59dd21fa385fbba1019174bc279be5514e58f0f  reader/src/main.rs
