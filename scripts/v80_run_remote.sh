#!/bin/bash
set -u
root=/mnt/v80-blocking-pool
prefix=s3://borsuk-bench-453182569524-euc1/research/v80-algorithm-first/blocking-pool
...
63d21790493b930a76d9033b91833c686979c78d1ebb8b4effc27480a9a4b833  reader/src/main.rs
...
for REGION in 1024 256; do
  set -- 512 2 128
  BORSUK_V71_REGIONS=$REGION BORSUK_V71_SHORTLIST=$1 BORSUK_V71_GAP=$2 BORSUK_V71_CONCURRENCY=$3     BORSUK_V71_OUTPUT="$root/result-r$REGION.json"     ./reader/target/release/v71_native_reader >> run.log 2>&1 || exit 98
done
phase=complete
exit 0
