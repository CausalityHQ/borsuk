#!/bin/bash
set -u
root=/mnt/v56-residual-pq24-8c46cfbd
output_uri=s3://borsuk-bench-453182569524-euc1/research/v56-algorithm-first/residual-pq24-8c46cfbde65f48b5/a0001
mkdir -p "$root" && cd "$root" || exit 90
prefix=s3://borsuk-bench-453182569524-euc1/research/v56-algorithm-first/residual-pq24-8c46cfbde65f48b5
aws s3 cp "$prefix/v56_algorithm_first_residual_pq24.py" probe.py --only-show-errors || exit 91
...
8c46cfbde65f48b5773fe56c1d9e562e84394c672aa64c950e652167097c536d  probe.py
...
code=$?
set -e
printf '{"exit_code":%d,"script_sha256":"8c46cfbde65f48b5773fe56c1d9e562e84394c672aa64c950e652167097c536d"}\n' "$code" > terminal.json
