#!/usr/bin/env python3
"""Export the V71 manifest so a native reader can serve V70's published index.
...
def main() -> None:
    ...
    with args.output.open("wb") as handle:
        handle.write(MAGIC)
        for value in (ROWS, DIMENSIONS, PAGE_ROWS, ROUTER_BLOCKS_PER_PAGE,
                      pages, QUERIES, NEIGHBORS):
