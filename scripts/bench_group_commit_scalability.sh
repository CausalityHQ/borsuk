...
if [[ "$SMOKE" == "1" ]]; then
  ...
  run_exact_lib_test lane_log::tests::v30_extent_plus_conditional_head_are_the_acknowledgement_boundary
  run_exact_lib_test lane_log::tests::v30_extent_completing_after_lease_guard_is_not_acknowledged
  run_exact_lib_test lane_log::tests::v30_linearizable_reader_trusts_the_conditionally_published_head
