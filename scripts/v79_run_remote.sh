#!/bin/bash
set -u
root=/mnt/v79-concurrency
prefix=s3://borsuk-bench-453182569524-euc1/research/v79-algorithm-first/concurrency
...
1998730465b9e4e5acbd5f2efd45a5b048af4052b0107b0a4d0f60bb91d86768  reader/src/main.rs
