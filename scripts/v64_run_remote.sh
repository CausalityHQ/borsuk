#!/bin/bash
set -u
digest=0850cde9d3be9a5147df6b6b277f500873400555ad0d9db8480bf23ab5cc4156
root=/mnt/v64-page-router-0850cde9
prefix=s3://borsuk-bench-453182569524-euc1/research/v64-algorithm-first/page-router-0850cde9d3be9a51
output_uri="$prefix/a0001"
terminal_file=/tmp/v64-page-router-terminal.json
phase=bootstrap
publish_terminal() {
  code=$?
  trap - EXIT
...
aws s3 cp "$prefix/v64_algorithm_first_page_router.py" probe.py --only-show-errors || exit 92
...
export OMP_NUM_THREADS=16 MKL_NUM_THREADS=16 OPENBLAS_NUM_THREADS=16 OPENBLAS64_NUM_THREADS=16
