    ...
    def test_assembles_query_build_and_resource_evidence(self) -> None:
        with tempfile.TemporaryDirectory() as temporary:
            ...
            (case / "bench_query_samples.csv").write_text(
                ...
                "borsuk-production-bench-v11,srht-pq-scan,scan,uncached,srht-pq-scan,8,320,0,1.5,17,0.99,3,7,2048,1024,8,0,0,0,0,0,0,0,0,0,srht-pq-scan,17,r01\n"
                "borsuk-production-bench-v11,srht-pq-scan,scan,disk_cached,srht-pq-scan,8,320,0,0.5,17,0.99,0,0,128,0,8,0,0,0,0,0,0,0,0,0,srht-pq-scan,17,r01\n"
            )
