...
def _query_result(
    ...
    return tuple(sources), {
        ...
        "leaves_eligible": routing["leaves_eligible"],
        "leaves_scanned": routing["leaves_scanned"],
        "peak_query_table_pairs_live": routing["peak_query_table_pairs_live"],
        "query_table_pairs_built": routing["query_table_pairs_built"],
