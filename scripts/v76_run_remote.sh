#!/bin/bash
set -u
root=/mnt/v76-throughput
prefix=s3://borsuk-bench-453182569524-euc1/research/v76-algorithm-first/throughput
...
23a161f5fc6af57e1f11d9b563424eac08368aca586633839f469727144428f0  reader/src/main.rs
...
for point in "256 2 128" "512 2 128"; do
  set -- $point
