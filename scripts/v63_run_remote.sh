#!/bin/bash
set -u
digest=420509b758524e05f7a6200eccfded2d83453c4ec4019da01dfbb615cc13cb1d
root=/mnt/v63-layout-oracle-420509b7
prefix=s3://borsuk-bench-453182569524-euc1/research/v63-algorithm-first/layout-oracle-420509b758524e05
