#!/bin/bash
set -u
root=/mnt/v73-row-router
prefix=s3://borsuk-bench-453182569524-euc1/research/v73-algorithm-first/row-router
...
: > run.log
for point in "512 2 128" "512 0 128" "512 4 128" "2048 2 128" "2048 0 128" "8192 2 128" "256 2 128"; do
  set -- $point
