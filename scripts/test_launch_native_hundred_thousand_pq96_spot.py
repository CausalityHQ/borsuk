"""Immutable Spot launch and terminal authority for the pq96 screen."""
...
from scripts.launch_native_hundred_thousand_pq96_spot import (
    build_launch_specs,
...
class Pq96SpotTest(unittest.TestCase):
    @staticmethod
    def plan() -> SpotLayoutPlan:
        ...
        return SpotLayoutPlan(
            ...
            output_prefix=(
                "s3://bucket/research/native-hundred-thousand-pq96/"
    ...
    def test_terminal_requires_exact_artifacts_and_decision(self) -> None:
        ...
        terminal["artifacts"].pop("pq-groups")
