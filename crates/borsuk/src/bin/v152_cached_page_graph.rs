//! GT-blind paired flat, V150, V151 and V152 page-plan measurement.
#![recursion_limit = "256"]
...
fn run() -> Result<(), Box<dyn Error>> {
    ...
    if args.len() != 6 {
        return Err(
            "usage: v152_cached_page_graph QUERIES ROUTING CENTROIDS GRAPH_OUT SUMMARY_OUT".into(),
        );
    }
    ...
    output.flush()?;
    let summary = json!({
        "schema": "borsuk-v152-cached-page-graph-plan-v1",
