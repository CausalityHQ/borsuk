...
pub use v36_funnel_geometry::{
    ...
    V36AdmittedSupercellPostCountPlan, V36AuthenticatedPostingCentroids,
    ...
    V36CenteredProjectionTrainingSpec, V36CenteredSampleRole, V36CommittedSupercellAssignments,
    ...
    encode_v36_supercell_run_chunk_arrow, project_v36_centered_row_scalar,
