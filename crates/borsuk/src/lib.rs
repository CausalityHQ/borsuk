...
pub use v36_funnel::{
    ...
    V36TransportDirectory, V36TransportDisposition, V36TransportFragment, V36TransportLimits,
...
pub use v36_funnel_code::{
    V36CoarseAssignmentIdentity, V36CoarseFragmentArm, V36CoarseFragmentArtifact,
    V36CoarseFragmentContext, V36CoarseFragmentRows, V36ResidualAssignmentBlockVisitor,
    V36ResidualAssignmentSource, V36ResidualPq4Codebook, V36ResidualPq4Record, V36ResidualPq4Width,
    V36Sign24Record, V36UniqueLiveTopK, audit_v36_coarse_fragment_sha256,
