...
pub use v30_s3_search::{
    ...
    V32Index, V32Match, V32PageSelection, V32PageStore, V32Router, V32RoutingDiagnostic,
    V32RoutingTargetReport, V32RoutingTargetStage, V32RoutingWork, V32SearchArm, V32SearchPhase,
    V32SearchResult, V32SearchWork, canonical_v32_cpu_preflight_receipt, v32_cpu_preflight_shape,
};
#[allow(
    dead_code,
