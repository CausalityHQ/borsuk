...
pub use v36_funnel_geometry::{
    ...
    V36AuthenticatedPostingCentroids, V36AuthenticatedSupercellModel, V36CenteredProjectedRow,
    ...
    authenticate_v36_posting_centroids, bind_v36_registered_supercell_training_spec,
    ...
    decode_v36_initial_assignment_merge_chunk_arrow, decode_v36_supercell_assignment_shard_arrow,
    decode_v36_supercell_model_arrow, decode_v36_supercell_run_chunk_arrow,
    derive_v36_posting_hnsw_levels, diagnose_v36_flat_centroid_scalar_simd,
    encode_v36_centered_projection_arrow, encode_v36_initial_assignment_merge_chunk_arrow,
    encode_v36_supercell_assignment_shard_arrow, encode_v36_supercell_model_arrow,
    encode_v36_supercell_run_chunk_arrow, plan_v36_initial_assignment_merge_generation,
