...
pub use v36_funnel_geometry::{
    ...
    V36GeometryAdmission, V36GeometryStop, V36PostingGaussianSummary, V36PostingPrototypeSummary,
    admit_v36_geometry, allocate_v36_hamilton_postings, build_v36_srht192_control,
