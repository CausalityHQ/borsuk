...
pub use v36_funnel_geometry::{
    ...
    V36ProjectedCorpusSource, V36RankedPosting, V36SupercellModel, V36SupercellTrainingPreflight,
    V36SupercellTrainingSpec, admit_v36_geometry, allocate_v36_hamilton_postings,
    assign_v36_postings, authenticate_v36_posting_centroids,
    bind_v36_registered_supercell_training_spec, build_v36_srht192_control,
    compare_v36_posting_prefixes, decode_v36_centered_projection_arrow,
    decode_v36_supercell_model_arrow, derive_v36_posting_hnsw_levels,
    diagnose_v36_flat_centroid_scalar_simd, encode_v36_centered_projection_arrow,
    encode_v36_supercell_model_arrow, project_v36_centered_row_scalar,
