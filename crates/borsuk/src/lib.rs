...
pub use v36_funnel::{
    ...
    V36PrefixResumeBinding, V36PrefixRoleAuthority, V36PrefixScreenManifest, V36PrefixSourceObject,
    V36PrimaryRows, V36ProjectionArm, V36RegisteredManifest, V36Replication, V36ResourceLedger,
    V36ResourceRequest, V36ShapeScore, V36TransportDisposition, V36TransportFragment,
    V36TransportLimits, V36TransportPlan, V36TransportPosting,
...
pub use v36_prefix_dataset::{
    V36PrefixCheckpointOutbox, V36PrefixExternalSelectionLimits, V36PrefixExternalSelectionRequest,
    ...
    V36PrefixInputRow, V36PrefixMaterializedRow, V36PrefixObjectPrefixScan,
    ...
    assign_v36_prefix_roles_from_selected_file, decode_v36_prefix_identity_run,
    ...
    load_v36_prefix_population_checkpoint_head, materialize_v36_prefix_role_parquets,
    rank_v36_prefix_source_objects, restore_v36_prefix_population,
    restore_v36_prefix_population_state, run_v36_prefix_freeze, scan_v36_prefix_gt100_parquet,
