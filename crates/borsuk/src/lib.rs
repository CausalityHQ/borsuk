...
pub use v36_prefix_dataset::{
    ...
    V36PrefixMaterializedRow, V36PrefixObjectPrefixScan, V36PrefixPopulationCommit,
    V36PrefixQualityRole, V36PrefixQueryRow, V36PrefixRankedSourceObject,
    V36PrefixRestoredPopulation, V36PrefixRoleParquetPaths, V36PrefixRoleSplit,
    ...
    scan_v36_prefix_object_prefix_checkpointed, scan_v36_prefix_query_parquet,
