...
pub mod physical_row_permutation;
...
pub use v36_funnel::{
    V36ArtifactIdentity, V36ChunkCeiling, V36CoarseCode, V36DecodedTransportPosting,
    V36DecodedTransportPrefix, V36FineCodec, V36FunnelManifest, V36GeometryArm,
    V36PrefixCheckpointContext, V36PrefixCheckpointManifest, V36PrefixCheckpointPhase,
    V36PrefixCheckpointPointer, V36PrefixCheckpointPointerCondition,
    ...
    V36TransportAuthority, V36TransportDirectory, V36TransportDisposition,
    V36TransportFetchObservation, V36TransportFragment, V36TransportLimits, V36TransportPlan,
    ...
    decode_v36_transport_prefix, plan_v36_prefix_checkpoint_dependency_closure,
    plan_v36_prefix_checkpoint_publication, plan_v36_transport, project_v36_resources,
    validate_v36_manifest, validate_v36_prefix_checkpoint_manifest,
...
pub use v36_funnel_code::{
    V36AuthenticatedCoarseFragment, V36CoarseAssignmentIdentity, V36CoarseFragmentArm,
    V36CoarseFragmentArtifact, V36CoarseFragmentContext, V36CoarseFragmentRows,
    V36ResidualAssignmentBlockVisitor, V36ResidualAssignmentSource, V36ResidualPq4Codebook,
    V36ResidualPq4Record, V36ResidualPq4Width, V36Sign24Record, V36UniqueLiveTopK,
    audit_v36_coarse_fragment_sha256, authenticate_v36_coarse_fragment,
    decode_v36_coarse_fragment_arrow, encode_v36_coarse_fragment_arrow,
    encode_v36_residual_pq4_record, encode_v36_sign24_record, score_v36_residual_pq4_record,
    score_v36_sign24_record, train_v36_residual_pq4,
};
#[doc(hidden)]
pub use v36_funnel_geometry::{
    ...
    V36CapacityOwnerPolicy, V36CenteredProjectedRow, V36CenteredProjection,
    ...
    V36CommittedSupercellAssignments, V36CommittedSupercellRuns, V36ExactAssignmentPreflight,
    V36ExternalMergeGenerationProjection, V36FollowupAssignmentMergeGeneration,
    V36FollowupAssignmentMergeRunSink, V36GeometryAdmission, V36GeometryStop,
    V36InitialAssignmentMergeChunkArtifact, V36InitialAssignmentMergeChunkContext,
    V36InitialAssignmentMergeGeneration, V36InitialAssignmentMergeGenerationSink,
    V36InitialAssignmentMergeGroup, V36InitialAssignmentMergeRunSink, V36PostingAcceleratorKind,
    V36PostingAcceleratorObservation, V36PostingAssignments,
    V36PostingCentroidDifferentialEvidence, V36PostingContainmentDiagnostic,
    V36PostingGaussianSummary, V36PostingHnswRecipe, V36PostingMissingCandidate,
    V36PostingOrderedDisagreement, V36PostingParityEvidence, V36PostingPrefixComparison,
    V36PostingPrefixContainment, V36PostingPrototypeSummary, V36PostingScoreContainment,
    V36PostingScoreKind, V36ProjectedCorpusBlockVisitor, V36ProjectedCorpusSource,
    V36PublicationCommitStatus, V36RankedPosting, V36ResidentPostingDiagnostic,
    V36ResidentPostingScoreModel, V36SupercellAssignmentAdmissionRequest,
    ...
    V36SupercellPostCountProjection, V36SupercellRunChunkArtifact, V36SupercellRunChunkContext,
    V36SupercellRunChunkSource, V36SupercellRunPublisherSink, V36SupercellTrainingPreflight,
    V36SupercellTrainingSpec, V36TerminalAssignmentSource, admit_v36_geometry,
    admit_v36_supercell_assignment_preflight, admit_v36_supercell_post_count,
    allocate_v36_hamilton_postings, assign_v36_capacity_aware_postings,
    assign_v36_capacity_aware_postings_with_closure,
    assign_v36_capacity_aware_postings_with_unpruned_owners, assign_v36_postings,
    ...
    authenticate_v36_supercell_assignment_root, authenticate_v36_supercell_assignment_shard_arrow,
    bind_v36_registered_supercell_training_spec, bind_v36_supercell_assignment_shard_context,
    bind_v36_supercell_run_chunk_context, build_v36_srht192_control,
    commit_v36_followup_assignment_merge_generation,
    commit_v36_initial_assignment_merge_generation, compare_v36_posting_prefixes,
    decode_v36_centered_projection_arrow, decode_v36_initial_assignment_merge_chunk_arrow,
    decode_v36_supercell_assignment_shard_arrow, decode_v36_supercell_model_arrow,
    decode_v36_supercell_run_chunk_arrow, derive_v36_posting_hnsw_levels,
    diagnose_v36_flat_centroid_scalar_simd, encode_v36_centered_projection_arrow,
    encode_v36_initial_assignment_merge_chunk_arrow, encode_v36_supercell_assignment_shard_arrow,
    ...
    evaluate_v36_posting_score_containment_with_model, load_v36_initial_assignment_merge_group,
    plan_v36_followup_assignment_merge_generation, plan_v36_initial_assignment_merge_generation,
    project_v36_centered_row_scalar, project_v36_centered_row_simd,
    ...
    publish_v36_supercell_run_chunks, rank_v36_selected_posting_candidates,
    run_v36_resident_posting_diagnostic, run_v36_resident_projected_posting_diagnostic,
    ...
    train_v36_resident_posting_score_model, train_v36_supercells, v36_effective_ef_search,
...
pub use v36_prefix_dataset::{
    ...
    V36PrefixFreezeRequest, V36PrefixGeometryConstructionInput,
    V36PrefixGeometryConstructionLocalFiles, V36PrefixGeometryConstructionLocalRequest,
    V36PrefixGeometryDevelopmentInput, V36PrefixGeometryDevelopmentLocalFiles,
    V36PrefixGeometryDevelopmentLocalRequest, V36PrefixGeometryInputs, V36PrefixGeometryLocalFiles,
    ...
    V36PrefixRankedSourceObject, V36PrefixResidentProjectedSource, V36PrefixRestoredPopulation,
    V36PrefixRoleAssignmentContract, V36PrefixRoleAssignmentFile, V36PrefixRoleAssignmentReceipt,
    V36PrefixRoleAssignmentRequest, V36PrefixRoleParquetPaths, V36PrefixRoleSplit,
    V36PrefixRowIdentity, V36PrefixSelectedFileReceipt, V36PrefixSelectedIds,
    V36PrefixSelectedIdsContract, V36PrefixSelectedIdsFile,
    assign_v36_prefix_roles_from_selected_file, bind_v36_prefix_external_selection_authority,
    bind_v36_prefix_geometry_inputs, bind_v36_prefix_role_assignment_contract,
    ...
    encode_v36_prefix_selected_ids, evaluate_v36_prefix_geometry_development,
    evaluate_v36_prefix_geometry_development_scores, exact_v36_prefix_gt100,
    ...
    load_v36_prefix_geometry_development_local_files, load_v36_prefix_geometry_local_files,
    load_v36_prefix_source_feature_ids, materialize_v36_prefix_assigned_roles,
    materialize_v36_prefix_checkpoint_selection, materialize_v36_prefix_role_parquets,
    next_v36_prefix_checkpoint_action, project_v36_prefix_source_resident,
