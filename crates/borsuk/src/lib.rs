...
pub use v36_funnel_geometry::{
    ...
    V36CommittedInitialAssignmentMergeRun, V36CommittedSupercellAssignments,
    V36ExactAssignmentPreflight, V36ExternalMergeGenerationProjection, V36GeometryAdmission,
    V36GeometryStop, V36InitialAssignmentMergeChunkArtifact, V36InitialAssignmentMergeChunkContext,
    V36InitialAssignmentMergeGeneration, V36InitialAssignmentMergeGroup,
    V36InitialAssignmentMergeRunSink, V36PostingAcceleratorKind, V36PostingAcceleratorObservation,
    V36PostingAssignments, V36PostingCentroidDifferentialEvidence, V36PostingGaussianSummary,
    V36PostingHnswRecipe, V36PostingMissingCandidate, V36PostingOrderedDisagreement,
    V36PostingParityEvidence, V36PostingPrefixComparison, V36PostingPrototypeSummary,
    V36ProjectedCorpusBlockVisitor, V36ProjectedCorpusSource, V36RankedPosting,
    ...
    V36SupercellAssignmentShardContext, V36SupercellAssignmentShardSink, V36SupercellModel,
    V36SupercellPostCountAdmissionRequest, V36SupercellPostCountProjection,
    V36SupercellRunChunkArtifact, V36SupercellRunChunkContext, V36SupercellTrainingPreflight,
    V36SupercellTrainingSpec, admit_v36_geometry, admit_v36_supercell_assignment_preflight,
    admit_v36_supercell_post_count, allocate_v36_hamilton_postings, assign_v36_postings,
    authenticate_v36_posting_centroids, authenticate_v36_supercell_assignment_shard_arrow,
    bind_v36_registered_supercell_training_spec, bind_v36_supercell_assignment_shard_context,
    bind_v36_supercell_run_chunk_context, build_v36_srht192_control, compare_v36_posting_prefixes,
    ...
    project_v36_supercell_training_preflight, rank_v36_selected_posting_candidates,
...
pub use v36_prefix_dataset::{
    ...
    V36PrefixGeometryInputs, V36PrefixGtAccumulator, V36PrefixGtHeapCheckpoint,
    ...
    complete_v36_prefix_checkpoint_ground_truth, decode_v36_prefix_gt_heap_checkpoint,
