...
pub use v36_funnel::{
    ...
    V36PrefixCheckpointPhase, V36PrefixFreezeAuthority, V36PrefixFreezeExecutionAuthority,
    V36PrefixFreezeReceipt, V36PrefixMaterializedArtifacts, V36PrefixPopulationAuthority,
    V36PrefixPopulationCheckpoint, V36PrefixRegisteredSourceObject, V36PrefixRoleAuthority,
    ...
    canonical_v36_prefix_checkpoint_manifest_bytes, canonical_v36_prefix_freeze_authority_bytes,
...
pub use v36_prefix_dataset::{
    ...
    V36PrefixGtParquetJob, V36PrefixGtRunStats, V36PrefixIdentityRun, V36PrefixInputRow,
    V36PrefixMaterializedRow, V36PrefixObjectPrefixScan, V36PrefixQualityRole, V36PrefixQueryRow,
    V36PrefixRankedSourceObject, V36PrefixRoleParquetPaths, V36PrefixRoleSplit,
    V36PrefixRowIdentity, decode_v36_prefix_identity_run, deduplicate_v36_prefix_row_identities,
    encode_v36_prefix_identity_run, exact_v36_prefix_gt100, load_v36_prefix_freeze_preflight,
    materialize_v36_prefix_role_parquets, rank_v36_prefix_source_objects,
    restore_v36_prefix_population, run_v36_prefix_freeze, scan_v36_prefix_gt100_parquet,
    scan_v36_prefix_object_prefix, scan_v36_prefix_query_parquet,
