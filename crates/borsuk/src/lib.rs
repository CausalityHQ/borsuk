...
pub use v36_funnel_geometry::{
    ...
    V36PostingPrefixContainment, V36PostingPrototypeSummary, V36ProjectedCorpusBlockVisitor,
    V36ProjectedCorpusSource, V36PublicationCommitStatus, V36RankedPosting,
    V36ResidentPostingDiagnostic, V36SupercellAssignmentAdmissionRequest,
    ...
    evaluate_v36_posting_prefix_containment, load_v36_initial_assignment_merge_group,
...
pub use v36_prefix_dataset::{
    ...
    exact_v36_prefix_gt100, externally_build_v36_prefix_identity_run,
    externally_select_v36_prefix_population_rows, load_v36_prefix_checkpoint_head,
    load_v36_prefix_freeze_preflight, load_v36_prefix_geometry_construction_local_files,
