...
pub use v36_funnel_geometry::{
    ...
    V36PostingCentroidDifferentialEvidence, V36PostingGaussianSummary, V36PostingHnswRecipe,
    V36PostingMissingCandidate, V36PostingOrderedDisagreement, V36PostingParityEvidence,
    ...
    plan_v36_initial_assignment_merge_generation, project_v36_centered_row_scalar,
    project_v36_centered_row_simd, project_v36_exact_assignment_preflight,
...
pub use v36_prefix_dataset::{
    ...
    V36PrefixFreezeRequest, V36PrefixGeometryConstructionInput, V36PrefixGeometryDevelopmentInput,
    V36PrefixGeometryInputs, V36PrefixGeometryLocalFiles, V36PrefixGeometryLocalRequest,
    V36PrefixGtAccumulator, V36PrefixGtHeapCheckpoint, V36PrefixGtHeapEntry, V36PrefixGtNeighbor,
    V36PrefixGtParquetJob, V36PrefixGtRunStats, V36PrefixIdentityRun, V36PrefixIdentityRunFile,
    V36PrefixInputRow, V36PrefixMaterializedCheckpointFiles, V36PrefixMaterializedRow,
    V36PrefixObjectPrefixScan, V36PrefixPhaseResumeRequest, V36PrefixPopulationCheckpointWriter,
    V36PrefixPopulationCommit, V36PrefixPopulationFileCommit, V36PrefixQualityRole,
    V36PrefixQueryRow, V36PrefixRankedSourceObject, V36PrefixResidentProjectedSource,
    V36PrefixRestoredPopulation, V36PrefixRoleAssignmentContract, V36PrefixRoleAssignmentFile,
    V36PrefixRoleAssignmentReceipt, V36PrefixRoleAssignmentRequest, V36PrefixRoleParquetPaths,
    V36PrefixRoleSplit, V36PrefixRowIdentity, V36PrefixSelectedFileReceipt, V36PrefixSelectedIds,
    ...
    load_v36_prefix_geometry_local_files, load_v36_prefix_source_feature_ids,
    ...
    run_v36_prefix_checkpoint_ground_truth, run_v36_prefix_checkpoint_gt100, run_v36_prefix_freeze,
