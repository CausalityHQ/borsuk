...
pub use v36_funnel_geometry::{
    ...
    V36RankedPosting, admit_v36_geometry, allocate_v36_hamilton_postings, assign_v36_postings,
    authenticate_v36_posting_centroids, build_v36_srht192_control, compare_v36_posting_prefixes,
    decode_v36_centered_projection_arrow, derive_v36_posting_hnsw_levels,
