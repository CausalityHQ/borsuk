//! Disposable ReLAION2B one-million-row row-preserving LSH probe.

use borsuk::{V45LshProbeRequest, run_v45_lsh_probe};
...
fn run() -> Result<Vec<u8>, String> {
    ...
    {
        return Err("V45 LSH probe arguments differ".to_owned());
    }
    run_v45_lsh_probe(V45LshProbeRequest {
