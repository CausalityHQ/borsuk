//! Disposable exact-original-space reducer control on ReLAION2B one million.

use borsuk::{V50ExactOriginalControlRequest, run_v50_exact_original_control};
...
fn run() -> Result<Vec<u8>, String> {
    ...
    {
        return Err("V50 exact-original control arguments differ".to_owned());
    }
    run_v50_exact_original_control(V50ExactOriginalControlRequest {
