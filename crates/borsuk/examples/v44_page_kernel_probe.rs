//! Disposable ReLAION2B one-million-row nonlinear page-kernel probe.

use borsuk::{V44PageKernelProbeRequest, run_v44_page_kernel_probe};
...
fn run() -> Result<Vec<u8>, String> {
    ...
    {
        return Err("V44 page kernel probe arguments differ".to_owned());
    }
    run_v44_page_kernel_probe(V44PageKernelProbeRequest {
